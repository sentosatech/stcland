...
This example shows a Sortable Item with remove button, icon that triggers a left side Tooltip.
...
This example combines draggable and droppable functionality with a remove button, and a helper icon that when hovered displays an tooltip.
